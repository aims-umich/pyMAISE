...
class ShapExplainers:
    ...
    def KernelSHAP(self, n_background_samples=500, n_test_samples=200, n_bootstrap=200):
        ...
        :param n_background_samples: (int less than total samples in X, default=500)
            Number of training samples used as background for integrating out features
        :param n_test_samples: (int less than total samples in X, default=200) Number of
            test samples used to estimate the Kernel SHAP importances
        :param n_bootstrap: (int, default=200) Number of times to re-evaluate the model
    ...
    def Exact_SHAP(self, nsamples=None):
        ...
        :param nsamples: (int less than total samples in X, default=None) Number of test
    ...
    def plot(
        ...
        :param output_name: (str, default=None) The name of the output variable the user
            is interested in plotting. Must be defined in output_names.
        :param output_index: (int, default=None) The index of the output variable the
            user is interested in plotting.
        :param method: (str, default=None) The key of the shap_raw array for the shap
            method a user wishes to plot. Options include: "DeepLIFT", "KernelSHAP",
            "IG", or "ExactSHAP"
        :param max_display: (int, default=20) The maximum number of input features that
            will be displayed on a beeswarm plot.
        :param run_name: (str, default=None) The name to save the figures as.
        :param save_figs: (bool, default=True) Whether or not to save the figures
